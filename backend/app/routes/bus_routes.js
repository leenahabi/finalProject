...
// router.post('/buses/new',(req,res,next) => {
...
//SHOW 
// GET - /buses/:id
router.get('/bus/:busId',requireToken,(req,res,next) => {
...
//PATCH -> small data
//PATCH - /cars/:id
// router.put('/buses/:busId/update',(req,res,next) => {
...
// router.put('/buses/edit/:id',requireToken,(req,res,next) => {
//     const id = req.params.id;
//     const update = req.body.bus;
